        ...
        try:
            ...
            for anomaly in anomalies:
                ...
                anomaly_details.append({
                    ...
                    "variacion_porcentual": float((precio - promedio) * 100 / promedio if promedio else 0)
                })
        ...
        try:
            ...
            cursor.execute("""
                ...
                WHERE id NOT IN (
                    ...
                    WHERE fecha_registro >= CURRENT_DATE - INTERVAL '180 days'
                )
                    ...
                    cursor.execute("""
                        WITH precio_extremo AS (
                            ...
                            HAVING pp.precio > 10 * AVG(pp2.precio)
                               OR pp.precio < 0.1 * AVG(pp2.precio)
                        )
